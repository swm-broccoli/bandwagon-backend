...
public interface RequestRepository extends JpaRepository<Request, Long> {
    ...
    boolean existsByUserAndBandAndType(User user, Band band, RequestType type);
    boolean existsByUserAndBandPostAndType(User user, BandPost post, RequestType type);
}
